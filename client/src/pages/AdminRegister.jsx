      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-7">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-400">Requires an admin registration secret</p>
          </div>
          ...
          <p className="text-center text-xs text-gray-500 mt-6">
            ...
            <button onClick={() => navigate("/adminl")} className="text-teal-600 font-semibold hover:underline">
              Sign in
            </button>
          </p>
